...
function correct() {
    if (pose)
    {
        ...
        {
            instr3 = 'Lift your arms facing your palms forward.';
            if(itext.innerHTML == ''){
                itext.innerHTML = instr3;
            }
            msg.text = "Lift your arms showing your palms.";
            window.speechSynthesis.speak(msg);
            correct = false;
        }
        else
        ...
        kdiffaL = Math.abs(kneeLX - ankleLX);
        if(kdiffaR > keys[3]["x"] || kdiffaL > keys[4]["x"])
        {
            instr4 = 'Bend your knees over ankles forming 90 degrees.';
            if(itext.innerHTML == ''){
                itext.innerHTML = instr4;
            }
            msg.text = 'Bend your knees over ankles.';
            window.speechSynthesis.speak(msg);
            correct = false;
        } 
        else
         ...
         if(correct == true)
        {
            ...
            setTimeout(function(){
            msg.text = "Perfect! Please hold the pose and breathe deeply. Inhale. Exhale. Inhale. Exhale. Inhale. Exhale. Stand straight. Next pose is.. One-Legged Goddess pose.";
            window.speechSynthesis.speak(msg);
            
            window.location.href = './olg_correct.html';
            }, 2000);
        }
