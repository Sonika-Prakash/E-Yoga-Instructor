    ...
    if (pose)
    {
        ...
        if(correct == true)
        {
            itext.innerHTML = '<span style="color: #18EB1D;">Perfect!</span>';
             ...
             setTimeout(function(){
            msg.text = "Perfect! Please hold the pose and breathe deeply. Inhale. Exhale. Inhale. Exhale. Inhale. Exhale. Stand straight. Next pose is.. Chair pose.";
            window.speechSynthesis.speak(msg);
            window.location.href = './c_correct.html';
            }, 2000);
        }
